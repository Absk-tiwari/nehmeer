...
export default function Register() {
    ...
    const handleLogin = async(event) => {
        ...
        try {
            axios.post(`auth/register`, fields ).then( async ({ data }) => {  
            if( data.authToken ) {

                localStorage.setItem('nehmeer-auth-token', data.authToken )
                localStorage.setItem('nehmeer-auth-user', JSON.stringify(data.user))
                    ...
                    <div className="row justify-content-center h-100">
                        <div className="col-lg-6 py-lg-5">
                            <div className="d-flex flex-column h-100 justify-content-center">
                                ...
                                <h2 className="fw-bold fs-24 text-center">Sign up</h2>
